...
public class Spacesuit {
    ...
    public String toString(){
        return "Это скафандр! Он состоит из трёх частей: " + jumpsuit.get_name(Case.GENITIVE, Case.LOW) + ", " + helmet.get_name(Case.GENITIVE, Case.LOW) + " и " + boots.get_name(Case.GENITIVE, Case.LOW) + ". "
